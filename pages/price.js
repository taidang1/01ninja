    ...
    <div className={styles.price_one}>
      <div className={styles.price_hero}>
        ...
        <div className={styles.price_hero_text}>
          ...
          <p style={{ paddingTop: "12px" }}>
            Our pricing is based on the complexity of your project. We offer a
        ...
        <img
          className={styles.price_hero_img}
        ...
        <motion.div   initial={{ y: 150, opacity: 0 }}
          ...
          <div className={styles.price_overview_text}>
            ...
            <p style={{ paddingBottom: "20px" }}>
              No page builders or third party iframes. We offer quality hand
              coded cannabis software solutions with superior results starting
              only at $249/mo
            </p>
            <p>
              Need something tailored to your needs?! We can create custom
              software solutions, pricing would depend on scope of work and time
              involved.
            </p>
          </div>
        </motion.div>
      ...
      <motion.div   initial={{ y: 150, opacity: 0 }}
        ...
        <div className={styles.price_est_text}>
          ...
          <p>
            We offer competitive pricing for all types of cannabis businesses to
            open the doors of digital opportunities
          </p>
        </div>
          ...
          <div className={styles.price_box_one}>
            ...
            <div className={styles.box_one_features}>
              <ul>
                ...
                <li>
                  Free hosting, SSL certification and personalized domain
                  integration
                </li>
                <li>
                  CMS content management system to manually customize your
                  content
                </li>
                <li>
          ...
          <div className={styles.price_box_two}>
            ...
            <div className={styles.box_two_features}>
              <ul>
                ...
                <li>
                  Sophisticated database system keeping track of all site and
                  customer data
                </li>
                <li>Cart checkout system</li>
                <li>Payment processing integration</li>
                <li>
                  Customer personal user login analytics and order history
                </li>
      ...
      <div className={styles.techstack_redirect}>
        <div className={styles.techstack_redirect_wrap}>
          <div className={styles.techstack_redirect_text}>
            <h2>
              Have more questions on our pricing or want a personalized quote
              from our finacial experts
            </h2>
          </div>
          <div>
            <button className={styles.techstack_redirect_btn}>
              Get started now
            </button>
          </div>
        </div>
